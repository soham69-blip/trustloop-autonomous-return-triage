...
def analyze_decision(
    ...
    # --------------------------------------------------------
        ...
        if (
            ...
            reason = (
                ...
                "but physical-condition claims require evidence "
                "review before refund approval."
            )
            ...
            reason = (
                "Physical damage was detected and the claim "
    ...
    return DecisionResult(
        ...
        claim_validity=claim_validity or 0.0,
